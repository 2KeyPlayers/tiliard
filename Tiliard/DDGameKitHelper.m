    ...
    [GKAchievement loadAchievementsWithCompletionHandler:^(NSArray* gcAchievementsArray, NSError* error)
     {
		 ...
		 if (willieM != nil) {
			 float tilesForWillieM = willieM.percentComplete;
			 tilesForWillieM = tilesForWillieM / 0.19015f;
			 NSInteger tpRanking = (NSInteger) tilesForWillieM;
			 
			 if (game.tpRanking < tpRanking) {
				 game.tpRanking = tpRanking;
			 }
			 /*if (game.tpRanking > 0) {
